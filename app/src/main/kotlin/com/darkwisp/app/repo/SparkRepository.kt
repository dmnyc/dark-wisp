            ...
            try {
                ...
                val transactions = response.payments.map { payment ->
                    ...
                    WalletTransaction(
                        ...
                        // Only a settled payment has a settle time. Stamping one
                        // unconditionally made pending and failed payments look
                        // like they had landed.
                        settledAt = if (payment.status == breez_sdk_spark.PaymentStatus.COMPLETED)
